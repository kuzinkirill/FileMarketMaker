...
import { type CancelLoanMethod } from './useCancelLoan.ts'

/**
 * same as AcceptLoanStore, but uses cancelLoan method and api.deals.cancelCreate
 */
